...
class GenerationMixin:
    ...
    def _prepare_encoder_decoder_kwargs_for_generation(
        ...
        irrelevant_prefix = ["decoder_", "cross_attn", "use_cache", "constrained_type", \
        "disjoint_entities", "valid_input", "empty_answer", "delimiters", "tokenizer"]
        encoder_kwargs = {
            argument: value
    ...
    def generate(
        ...
        disjoint_entities: Optional[List[torch.tensor]] = None,
    ...
    def set_scores_to_inf_for_invalid_inputs(self, scores, input_ids, disjoint_entities, context, empty_answer, delimiters, eos_token_id, constrained_type, tokenizer):
        ...
        for beam_idx, (cur_ent, cur_inp) in enumerate(zip(cur_entities, cur_input)):
            ...
            if force_entity[beam_idx]:
                ...
                if 'sampling' in constrained_type:
                    valid_mask_list = [[beam_idx, eos_token_id]]
            ...
            rscores, rids = torch.topk(scores[beam_idx], , dim=1, largest=True, sorted=True)
